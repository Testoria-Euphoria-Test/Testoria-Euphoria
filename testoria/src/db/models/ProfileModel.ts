...
import { ProfileInput, ProfileType } from "@/types/profle";
...
const ProfileSchema = z.object({
    ...
    certificates: z.array(z.string().trim().min(1, "Certificate url cannot be empty")).max(10, "Too many certificates").optional(),
