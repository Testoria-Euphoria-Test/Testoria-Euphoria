  ...
  const loadProfile = async () => {
    try {
      ...
      if (!response.ok) {
        ...
        // If profile doesn't exist (404) or other error, set default empty profile
        if (response.status === 404) {
          console.log("Profile not found, using default empty profile");
        } else {
          console.warn("Profile API error:", response.status);
        }
      ...
      if (data.success && data.data) {
        ...
        // API returned success but no data, use default profile
        console.log(
          "Profile API returned no data, using default empty profile"
        );
        const defaultProfile: ProfileData = {
          userId: "",
          photoUrl: "",
      ...
      // Even on error, set default profile so page can still be used
      ...
      if (error instanceof Error && error.message !== "Failed to fetch") {
        toast.error("Could not load profile data, showing default profile");
      }
    } finally {
      setLoading(false);
    }
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  {isEditing
                    ? "Edit your profile information and documents"
                    ...
                    : "Create your professional creator profile"}
                </p>
              </div>
            </div>
                    ...
                    <div>
                      ...
                      {profileData.bio ? (
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                          ...
                          <p className="text-gray-400 text-xs mt-1">
                            Tell students about your experience and teaching
                            style
                          </p>
                          <button
                            onClick={() => setIsEditing(true)}
                  ...
                  <div className="mt-8 pt-8 border-t border-gray-200">
                    ...
                    <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 text-center">
                      ...
                      <p className="text-gray-400 text-xs mb-3">
                        Upload your professional certificates to showcase your
                        expertise
                      </p>
                      <button
                        onClick={() => setIsEditing(true)}
                ...
                {!profileData.education &&
                  ...
                  !profileData.photoUrl && (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500 mb-2">
                        Complete your creator profile to build trust with
                        students
                      </p>
                      <p className="text-gray-400 text-sm mb-4">
                        Add your photo, education, bio, and certificates to
                    ...
                    <div className="grid grid-cols-1 gap-6">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500text-gray-700 text-gray-700"
                          maxLength={200}
                        />
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          rows={6}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-vertical text-gray-700"
                          maxLength={500}
                        />
                        <p className="text-xs text-gray-500 mt-1">
